...
namespace MassarAdminDesktop
{
    class pdf
    {
        ...
        BaseFont bf;
        Font myfont;
        public pdf(string pdfdirectory, string id = "11671321", string semestre = "1", string annee = "2017/2018", string ecole = "amana")
        {
            ...
            iTextSharp.text.Image pic = iTextSharp.text.Image.GetInstance("C:\\Fonts\\img.png");
